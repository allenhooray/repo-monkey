  ...
  container.innerHTML = `
    <div class="card">
      ...
      <div class="form-group">
        ...
        <input type="text" id="accessToken" placeholder="ghp_xxxxxxxxxxxx" value="${escapeHtml(settings.accessToken)}">
      ...
      <div class="form-group">
        ...
        <input type="text" id="repoOwner" placeholder="username or organization" value="${escapeHtml(settings.repoOwner)}">
      </div>
      <div class="form-group">
        <label for="repoName">Repository Name</label>
        <input type="text" id="repoName" placeholder="repo-name" value="${escapeHtml(settings.repoName)}">
      </div>
      <div class="btn-group">
